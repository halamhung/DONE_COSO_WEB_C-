...
namespace HQKTravel.Controllers
{
    public class GuestController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Register(FormCollection collection, user_account guest, HttpPostedFileBase fileImage)
        {
        ...
        public ActionResult Login(FormCollection collection)
        {
            ...
            else
            {
                ...
                if (guest != null)
                {
                    ...
                    Session["user_image"] = guest.user_image;
                    return RedirectToAction("Index", "Home");
                }
        ...
        [HttpPost]
        public ActionResult profile(String Fullname, String Phone, String Email, HttpPostedFileBase fileImage)
        {
            var userid = (long)Session["user_id"];
            ...
            if (fileImage != null && fileImage.ContentLength > 0)
            {
                ...
                fileImage.SaveAs(path);
                oldCustomer.user_image = "~/Assets/User/img_account/" + fileName;
